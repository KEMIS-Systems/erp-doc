...
**[Grupo de acesso](./access-groups.md)**, que determina, tela por tela, se
...
**[Departamentos](./departments.md)** (que se dividem em seções e podem ser
...
**[Clientes](./customers.md)** e **[Fornecedores](./vendors.md)** compartilham
...
empresa fecha **[Contratos](./contracts.md)** — que por sua vez organizam
...
**[Formulários de Avaliação de Fornecedores](./evaluation-forms.md)** permitem
...
- [Grupos de acesso](./access-groups.md)
- [Usuários](./users.md)
- [Clientes](./customers.md)
- [Fornecedores](./vendors.md)
- [Departamentos](./departments.md)
- [Centros de custo](./cost-centers.md)
- [Gestores](./managers.md)
- [Contratos](./contracts.md)
- [Gerenciador de arquivos](./file-manager.md)
- [Formulários de Avaliação de Fornecedores](./evaluation-forms.md)
